...
function criaPedido(nomeCliente, corteId, barbaId) {
    var corte = buscaCortePorId(corteId);
    var barba = buscaBarbaPorId(barbaId);
    if (corte == "Corte não encontrado" || barba == "Barba não encontrada") {
...
function calculaTotal(pedido) {
    var precoTotal = pedido.pedidoBarbaPreco+ pedido.pedidoCortePreco
    pedido = precoTotal
    return pedido
}
